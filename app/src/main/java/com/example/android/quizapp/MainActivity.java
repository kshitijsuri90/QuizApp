...
public class MainActivity extends AppCompatActivity {
    private Question_Library questions = new Question_Library();
    ...
    private FloatingActionButton previousquestion;
        ...
        Choice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Choice1.getText() == Answer){
                    ...
                    Toast.makeText(MainActivity.this, "Bravo! You got it correct", Toast.LENGTH_LONG).show();}
    ...
    private void updateQuestion(){
        if( QuestionNumber !=5){
            ...
            QuestionNumber++;
            numberOfTheQuestion.setText("Question Number: -"+ QuestionNumber);
        }
        else{
            String score_string = "" + Score;
            Intent result = new Intent(MainActivity.this, QuestionsActivity.class);
